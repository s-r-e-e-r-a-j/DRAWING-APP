...
let backgroundButton = document.querySelector("#color-background");
let colorButton = document.querySelector("#color-input");
let clearButton = document.querySelector("#button-clear");
let eraseButton = document.querySelector("#button-erase");
let penButton = document.querySelector("#button-pen");
let penSize = document.querySelector("#pen-slider");
let toolType = document.querySelector("#tool-type");
